...
import { GoogleMap, LoadScript, Polygon, PolygonF, useLoadScript } from '@react-google-maps/api'
...
function EditMap({ apiKey, paths, point, center, setPoint, close, id, color, setColor }) {
    ...
    const updateMap = async () => {
        ...
        await axios.post('http://localhost:8000/api/updateGeoMap', { parentId: id, coordinates: new_path, color: editColor })
            .then(response => {
                if (response) {
