...
import image from "../../resources/assets/images/3135715.png"
                        ...
                        <div className="dropdown d-inline-block">
                            ...
                            >
                                <img
                                    ...
                                    // src={userRole === "restaurant" ? "" : settingsData?.app_logo}
                                    src={logo}
                                    alt="Admin"
                            ...
                            <div className="dropdown-menu dropdown-menu-end">
                                <a className="dropdown-item" onClick={() => Navigate('/admin/generalSettings')}>
                                    <i className="uil uil-user-circle font-size-18 align-middle text-muted me-1"></i>{" "}
                                    <span className="align-middle">View Profile</span>
                                </a>

                                {isAdmin && (
                                    <a className="dropdown-item" onClick={() => Navigate('/admin/showSubAdmin')}>
                                        <i className="uil uil-sign-out-alt font-size-18 align-middle me-1 text-muted"></i>{" "}
                                        <span className="align-middle" >Sub Admin</span>
                                    </a>
                                )}

                                <a className="dropdown-item d-block" onClick={() => Navigate('/admin/pageSettings')}>
