    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (role === 'admin') {
                ...
                try {
                    const response = await axios.post(`${url}/subAdmin/login`, { username, password },
                        {
                            headers: {
                                Authorization: `${adminToken}`,
                            },
                ...
                try {
                    const response = await axios.post(`${url}/restaurant/login`, { username, password },
                        {
                            headers: {
                                Authorization: `${adminToken}`,
                            },
                                ...
                                <div className="card">
                                    ...
                                    <div className="card-body p-4">
                                        <div className="text-center mt-2">
                                            ...
                                            <p className="text-muted">Sign in to continue to OMC.</p>
                                        </div>
