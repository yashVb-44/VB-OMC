...
const EditCategory = () => {
    ...
    const [categoryName, setCategoryName] = useState(selectedCategoryData?.name);
    const [categoryImage, setCategoryImage] = useState(null);

    const [previewImage, setPreviewImage] = useState(selectedCategoryData?.image);
        ...
        if (categoryName !== "") {
            ...
            try {
                ...
                let response = await axios.put(
                    `${url}/category/update/byAdmin/${selectedCategoryData?._id}`,
                    formData,
                    {
                        headers: {
