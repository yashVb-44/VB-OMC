...
const ShowCategory = () => {
    ...
    useEffect(() => {
        async function getCategory() {
            ...
            try {
                const res = await axios.get(`${url}/category/list/get`,
                    {
                        headers: {
    ...
    const handleCategoryFeatureStatus = async (Category, newStatus) => {
        try {
            ...
            const updatedCategoryData = CategoryData.map((c) =>
                c._id === Category._id ? { ...c, feature: newStatus } : c
            );
                    ...
                    <div className="container-fluid">
                        <div className="row">
                            ...
                            <div className="d-flex flex-wrap gap-2 mt-2">
                                <button onClick={() => Navigate("/admin/addCategory")} className="btn btn-primary waves-effect waves-light">
