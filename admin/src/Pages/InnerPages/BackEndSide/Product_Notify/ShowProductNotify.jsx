...
const ShowProductNotify = () => {
        ...
        },
        {
            ...
            renderCell: (params) => (
                <Stack direction="row">
                    ...
                    >
                        <i class="fas fa-angle-double-right font-size-16 font-Icon-view"></i>
                    </IconButton>
    ...
    // send notification of product to user
    const handleSendNotification = (data) => {
        Swal.fire({
            title: "Are you sure?",
            text: "For send notification for this product!",
            icon: "warning",
            ...
            if (result.isConfirmed) {
                ...
                axios
                    .post(`${url}/notification/notify/byadmin`,
                        {
                            headers: {
                                Authorization: `${adminToken}`,
                            },
                    ...
                    .then(() => {
                        Swal.fire("Success!", "Notification has been sent successfully!", "success");
                    })
            }
        });
    };
