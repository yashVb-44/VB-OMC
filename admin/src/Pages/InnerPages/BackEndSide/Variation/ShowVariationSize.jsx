...
const ShowVariationSize = () => {
    ...
    useEffect(() => {
        async function getProduct() {
            try {
                ...
                setsizeData(res?.data?.variation?.Variation_Size || [])
                setIsLoading(false)
            } catch (error) {
                setIsLoading(false)
            }
    ...
    const columns = [
        ...
        {
            field: "R1_Min_Quantity",
            headerName: "R1_Min_Quantity",
            width: 160,
            filterable: true,
            sortable: true,
            filterType: "multiselect",
        ...
        {
            field: "R2_Min_Quantity",
            headerName: "R2_Min_Quantity",
            width: 160,
            filterable: true,
            sortable: true,
            filterType: "multiselect",
        ...
        {
            field: "R3_Min_Quantity",
            headerName: "R3_Min_Quantity",
            width: 160,
            filterable: true,
            sortable: true,
            filterType: "multiselect",
        ...
        {
            field: "R4_Min_Quantity",
            headerName: "R4_Min_Quantity",
            width: 160,
            filterable: true,
            sortable: true,
            filterType: "multiselect",
