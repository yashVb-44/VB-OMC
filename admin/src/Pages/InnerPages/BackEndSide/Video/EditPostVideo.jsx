...
const EditPostVideo = () => {
    ...
    const selectedVideo = useSelector((state) => state?.VideoDataChange?.payload)

    const Navigate = useNavigate()
    const [postVideoName, setPostVideoName] = useState(selectedVideo?.post_video_Name);
        ...
        if (postVideoName !== "") {
            ...
            try {
                let response = await axios.put(
                    `${url}/postVideo/update/${selectedVideo?._id}`,
                    {
                        name: postVideoName,
                    },
                    {
                ...
                let alertBox = document.getElementById('alert-box')
                alertBox.classList.add('alert-wrapper')
                setStatusMessage("Post Video not Update !");
            }
        }
    };
                                            ...
                                            <div className="row mb-10">
                                                <div className="col ms-auto">
                                                    <div className="d-flex flex-reverse flex-wrap gap-2">
                                                        <a className="btn btn-danger" onClick={() => Navigate('/admin/showPostVideo')}>
                                                            {" "}
