...
const EditWarningLabels = () => {
    const Navigate = useNavigate();
    const selectedWarningLabelsData = useSelector((state) => state?.WarningLabelsDataChange?.payload);

    const [warningLabelsName, setWarningLabelsName] = useState(selectedWarningLabelsData?.name);
    const [warningLabelsImage, setWarningLabelsImage] = useState(null);

    const [previewImage, setPreviewImage] = useState(selectedWarningLabelsData?.image);
        ...
        if (warningLabelsName !== "") {
            ...
            try {
                ...
                let response = await axios.put(
                    `${url}/warningLabels/update/byAdmin/${selectedWarningLabelsData?._id}`,
                    formData,
                    {
                        headers: {
                ...
                let alertBox = document.getElementById("alert-box");
                alertBox.classList.add("alert-wrapper");
                setStatusMessage("Warning-Labels not Update !");
            }
        }
    };
                        ...
                        <div className="row">
                            <div className="col-12">
                                <div className="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 className="mb-0">Edit WarningLabels</h4>
                                </div>
                            </div>
                        </div>
                        <div className="row">
                                                ...
                                                <div className="col-md-10">
                                                    ...
                                                    <div className="fileupload_img col-md-10 mt-3">
                                                        <img
                                                            ...
                                                            src={
                                                                previewImage ||
                                                                `${url}/${selectedWarningLabelsData?.WarningLabels_Image}`
                                                            }
...
export default EditWarningLabels;
