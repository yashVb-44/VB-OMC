...
const EditCoupon = () => {
        ...
        async function getCouponDetails() {
            try {
                ...
                if (response.data.type === "success") {
                    ...
                    setMaxDisc(couponData?.maxDiscount)
                    setMinAmount(couponData?.minAmount)
                    setDiscountPerc(couponData?.discountPercent)
    ...
    const handleSubmit = async (e) => {
        ...
        if (couponCode && discountAmount && expiryDate && usageLimits) {
            ...
            try {
                let response = await axios.put(`${url}/coupon/update/admin/${couponId}`, formData,
                    {
                        headers: {
                            Authorization: `${adminToken}`,
                        },
                                                ...
                                                <div className="col ms-auto">
                                                    <div className="d-flex flex-reverse flex-wrap gap-2">
                                                        <a
                                                            ...
                                                            onClick={() => Navigate(`/admin/showCoupon`)}
                                                        >
                                                            {" "}
