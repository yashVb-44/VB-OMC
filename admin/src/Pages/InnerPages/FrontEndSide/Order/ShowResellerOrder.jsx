...
import { editOrder, orderTrackId } from "../../../../Redux/Actions/FronendActions/OrderActions";
...
const ShowResellerOrder = () => {
    ...
    useEffect(() => {
        async function getOrder() {
            try {
                const res = await axios.get(`${url}/order/reseller/get/all`,
                    {
                        headers: {
    ...
    const handleOrderUpdate = (id, trackId) => {
        dispatch(editOrder(id))
        dispatch(orderTrackId(trackId))
                            ...
                            <div className="datagrid-container">
                                ...
                                {selectedRows.length > 0 && (
                                    <div className="row-data">
                                        <div>{selectedRows.length} Reseller Order selected</div>
                                        <DeleteIcon
                                            style={{ color: "red" }}
...
export default ShowResellerOrder;
