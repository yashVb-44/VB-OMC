...
const EditUser = () => {
    ...
    const [dob, setdob] = useState(selectedUserData?.DOB)
    const [Wallet, setWallet] = useState(selectedUserData?.Wallet)
    const [WalletLimit, setWalletLimit] = useState(selectedUserData?.WalletLimit)
                                            ...
                                            <div className="mb-3 row">
                                                ...
                                                <div className="col-md-10">
                                                    ...
                                                    >
                                                        ...
                                                        <option value="1">Premium Bulk Buyer</option>
                                                        <option value="2">Bulk Buyer </option>
                                                        <option value="3">Premium Reseller</option>
